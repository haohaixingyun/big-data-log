...
public class RandomLog {
	public static String day ="20160632";
	...
	static String [] mids={"Mary", "Patricia", "Linda", "Barbara", "Elizabeth", "Jennifer", "Maria", "Susan",
	...
	static String [] browsers = {"Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/46.0.2490.71 Safari/537.36",
	...
	public static void main(String[] args) {
		...
		try {
			writer = new FileWriter("F://access2.log", true);
		...
		for (int j = 0; j < 50000; j++) {
			...
			str.append("ver=1&pl=website&sdk=js&l=zh-CN&b_rst=1536*864&c_time="+d[1]);
			...
			if((r.nextInt(10)>4&&uids.size()<10000)|| j<20){//新用户
				...
				writer.write(getP_V(str, uid, sid, mids[r.nextInt(mids.length)], browserInfo));
	...
	public static String getP_l(StringBuilder str ,String uid,String sid,String binfo)throws Exception{
	...
	public static String getP_V(StringBuilder str ,String uid,String sid,String mid,String binfo)throws Exception{
	...
	public static String[] getDatetime(String day)throws Exception{
		String d = day+String.format("%02d%02d%02d",new Object[]{r.nextInt(24),r.nextInt(60),r.nextInt(60)});
